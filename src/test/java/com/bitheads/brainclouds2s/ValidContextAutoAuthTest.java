...
public class ValidContextAutoAuthTest extends TestFixtureBase {
    public ValidContextAutoAuthTest() {
        m_autoAuth = true;
    }
    ...
    public void runScript() {
        runSimple("{\"service\":\"script\",\"operation\":\"RUN\",\"data\":{\"scriptName\":\"testScript2\"}}");
    }
    ...
    public void successsiveCalls() {
        ...
        if (successCount != 5) fail("successCount != 5");
    }

    @Test
    public void badRequestJson() {
        runSimpleExpectFail("Bad Request");
    }

    @Test
    public void badRequest() {
        runSimpleExpectFail("{\"service\":\"bad_service\",\"operation\":\"bad_op\",\"data\":{}}");
    }
}
